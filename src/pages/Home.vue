<template>
	...
	<el-row class="container">
	  ...
	  <el-dialog title="修改密码" v-model="passwordDialogVisible" size="tiny">
		<el-form :model="ruleForm" ref="ruleForm" label-width="80px" style="padding-right:50px"  :rules="rules">
		...
		<div slot="footer" class="dialog-footer">
			<el-button type="primary" @click="doModify('ruleForm')">确认</el-button>
		...
		methods: {
			...
			logout: function () {
				...
				this.$confirm('确认退出吗?', '提示', {
					...
					_this.$router.options.routes = routes
			...
			doModify(formName){
				this.$refs[formName].validate((valid) => {
          		if (valid) {
				let url = '/api/management/changePassword?id='+this.ruleForm.id+'&password='+this.ruleForm.password
